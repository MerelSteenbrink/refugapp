...
ru1 = User.create!(username: "Ricky", description: "so I would love to meet people", first_name: "Ricardo", last_name: "Del Mar", kind: "refugee", city: "Hoofddorp", email: "raindance@gmail.com", password: "password", password_confirmation: "password", picture: "http://res.cloudinary.com/gg/image/upload/v1467114164/male5_j6lwpc.jpg")
...
ru6 = User.create!(username: "batman", description: "so I would love to meet people", first_name: "Tarek", last_name: "Nour", kind: "refugee", city: "Den Haag", email: "t.nour@hotmail.com", password: "password", password_confirmation: "password", picture: "http://res.cloudinary.com/gg/image/upload/v1467114165/male2_sbfcv6.png")
...
du2 = User.create!(username: "Sooph", description: "so I would love to meet people", first_name: "Sophia", last_name: "De Jong", kind: "dutchie", city: "Utrecht", email: "sooph_87@gmail.com", password: "password", password_confirmation: "password", picture: "http://res.cloudinary.com/gg/image/upload/v1467114165/woman5_y5n9zj.jpg")
du3 = User.create!(username: "Miri", description: "so I would love to meet people", first_name: "Miriam", last_name: "De Vries", kind: "dutchie", city: "Amsterdam", email: "mdevries@gmail.com", password: "password", password_confirmation: "password", picture: "http://res.cloudinary.com/gg/image/upload/v1467114165/woman4_c4germ.jpg")
...
du5 = User.create!(username: "Noor", description: "so I would love to meet people", first_name: "Eleonore", last_name: "Van Den Helder", kind: "dutchie", city: "Schiedam", email: "new_noor@gmail.com", password: "password", password_confirmation: "password", picture: "http://res.cloudinary.com/gg/image/upload/v1467114164/woman7_ljino3.jpg")
du6 = User.create!(username: "Stijn", description: "so I would love to meet people", first_name: "Stijn", last_name: "Janssen", kind: "dutchie", city: "Almere", email: "stijn_jj@gmail.com", password: "password", password_confirmation: "password", picture: "http://res.cloudinary.com/gg/image/upload/v1467116147/male12_rm2hkj.jpg")
